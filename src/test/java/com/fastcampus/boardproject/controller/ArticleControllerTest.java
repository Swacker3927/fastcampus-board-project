...
import com.fastcampus.boardproject.domain.dto.request.ArticleRequest;
import com.fastcampus.boardproject.domain.dto.response.ArticleResponse;
...
class ArticleControllerTest {
    ...
    @DisplayName("[view][GET] 새 게시글 작성 패이지")
    @Test
    ...
    @Test
    void givendArticleIdToDelete_whenRequesting_thenDeletesArticle() throws Exception {
        // Given
        long articleId = 1L;
